...
<body id="fullClient">
    ...
    <!-- NOTE: OpenLayer 2.13 is a bit jumpy on the iPad. We will stick with 2.12 until we find something that justify this upgrade -->
    ...
    <#if (googleAPIKey?? && googleAPIKey != "")>
        ...
        <script type="text/javascript" src="https://maps.google.com/maps/api/js?v=3.7&amp;key=${googleAPIKey}"></script>
    </#if>
