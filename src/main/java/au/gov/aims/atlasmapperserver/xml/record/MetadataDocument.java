...
public abstract class MetadataDocument {
    ...
    public MetadataDocument(String uri) {
        this.uri = uri;
    }
        ...
        try {
            ...
            if (_links != null && !_links.isEmpty()) {
                ...
                for (Link link : this.getLinks()) {
                    linksArray.put(link.toJSON());
                }
            }

            json.put("uri", this.getUri())
                    .put("abstract", this.getAbstract())
        ...
        public JSONObject toJSON() {
            ...
            try {
                json.put("url", this.getUrl())
                        ...
                        .put("applicationProfile", this.getApplicationProfile());
            } catch (JSONException e) {
                // Fail silently
            }
    ...
    public enum Protocol {
        ...
        // MCP 1.4 (GeoNetwork 2.8.0) and ISO19115-3.2018 (GeoNetwork 3.x+)
        WWW_LINK                            ("WWW:LINK"),                             // Web address (URL)
        ...
        OGC_WMTS                            ("OGC:WMTS"),                             // OGC-WMTS Tiled Web Map Service
        ...
        // ISO19115-3.2018 (GeoNetwork 3.x+)
        ESRI_REST                           ("ESRI:REST"),
        ESRI_REST_TILED                     ("ESRI:REST-TILED"),
        INSPIRE_ATOM                        ("INSPIRE Atom");
