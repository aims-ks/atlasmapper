...
public class ArcGISMapServerLayerGeneratorTest {
    ...
    @Test
    public void testLayerGetJSONUrlMissingArcGISPath() throws Exception {
        ArcGISMapServerLayerGenerator layerGenerator = new ArcGISMapServerLayerGenerator();
        ...
        String jsonUrlStr = layerGenerator.getJSONUrl("http://maps2.six.nsw.gov.au/arcgis/rest/services/sixmaps/Cadastre/MapServer", arcGISPath, type, layerId);
        Assert.assertEquals("http://maps2.six.nsw.gov.au/arcgis/rest/services/sixmaps/Cadastre/MapServer/0?f=json&pretty=true", jsonUrlStr);

        jsonUrlStr = layerGenerator.getJSONUrl("http://maps2.six.nsw.gov.au/arcgis/rest/services/sixmaps/Cadastre/MapServer/", arcGISPath, type, layerId);
        Assert.assertEquals("http://maps2.six.nsw.gov.au/arcgis/rest/services/sixmaps/Cadastre/MapServer/0?f=json&pretty=true", jsonUrlStr);
    }
}
