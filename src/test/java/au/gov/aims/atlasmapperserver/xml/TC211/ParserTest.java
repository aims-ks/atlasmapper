...
public class ParserTest extends TestCase {
	public void testParseURIFullDocument() throws Exception {
		...
		Document doc = Parser.parseURI(url.toString());
	...
	public void testParseURIInternetDocument() throws Exception {
		String url = "http://mest.aodn.org.au/geonetwork/srv/en/iso19139.xml?uuid=87263960-92f0-4836-b8c5-8486660ddfe0";
		Document doc = Parser.parseURI(url);
