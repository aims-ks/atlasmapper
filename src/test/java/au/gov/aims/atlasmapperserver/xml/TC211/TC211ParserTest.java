...
public class TC211ParserTest {
    ...
    public void testCraftGeoNetworkMestUrl() throws Exception {
        ...
        Assert.assertEquals("http://www.cmar.csiro.au/geonetwork/srv/en/iso19139.xml?id=44003", craftedUrl.toString());
        ...
        Assert.assertEquals("http://www.cmar.csiro.au/geonetwork/srv/en/iso19139.xml?uuid=urn:cmar.csiro.au:dataset:13028", craftedUrl.toString());
        ...
        Assert.assertEquals("https://www.cmar.csiro.au:8443/geonetwork/srv/en/iso19139.xml?id=44003", craftedUrl.toString());
        ...
        Assert.assertEquals("http://www.cmar.csiro.au/geonetwork/srv/en/iso19139.xml?uuid=urn:cmar.csiro.au:dataset:13028&currTab=full", craftedUrl.toString());
        ...
        Assert.assertEquals("http://www.cmar.csiro.au/geonetwork/srv/en/iso19139.xml?id=44003&currTab=full", craftedUrl.toString());
        ...
        Assert.assertEquals("http://www.cmar.csiro.au/geonetwork/srv/en/iso19139.xml?currTab=full&id=44003", craftedUrl.toString());
        ...
        Assert.assertEquals("http://www.google.com/iso19139.xml?id=44003", craftedUrl.toString());
